    ...
    return (
        <div className="flex items-center gap-4 mr-[-23px]">
            <div className="flex gap-2">
                <a
                    href="https://github.com/neverNotTired"
                    target="_blank"
                    className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 bg-[#2d353e] text-white gap-2 text-sm font-bold leading-normal tracking-[0.015em] min-w-0 px-2.5"
                >
                    <span
                ...
                <a
                    href="https://www.linkedin.com/in/john-taylor-710497109/"
                    target="_blank"
                    className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 bg-[#2d353e] text-white gap-2 text-sm font-bold leading-normal tracking-[0.015em] min-w-0 px-2.5"
                >
                    <span
